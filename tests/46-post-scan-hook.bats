...
# ---------------------------------------------------------------------------
# J-01 to J-15: _json_escape_string unit tests
...
@test "J-15: _json_escape_string: function body does not reference sed" {
    ...
    # Helper was promoted from lmd_hook.sh to lmd.lib.sh in v2.0.1 (issue #482).
    local lib_src="$LMD_INSTALL/internals/lmd.lib.sh"
    [ -f "$lib_src" ]
