...
install -m 640 files/internals/ignore_inotify.defaults %{buildroot}/usr/lib/maldet/internals/ignore_inotify.defaults
...
ln -sf /usr/lib/maldet/internals/ignore_inotify.defaults %{buildroot}/usr/local/maldetect/internals/ignore_inotify.defaults
...
%attr(640,root,root) /usr/lib/maldet/internals/ignore_inotify.defaults
...
/usr/local/maldetect/internals/ignore_inotify.defaults
